    ...
    <div class="flex gap-4 items-stretch justify-stretch slider-testimony-item">
        <div class="md:w-5/12">
        ...
        <div class="md:w-7/12 border border-slate-300 rounded-xl p-6">
            ...
            <h3 class="my-4 text-4xl medium text-secondary">
                {{$title}}
            </h3>
            {{$slot}}
        </div>
