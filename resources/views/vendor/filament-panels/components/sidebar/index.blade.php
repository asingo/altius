...
{{--            <li>--}}
{{--                <ul>--}}
{{--                    <li x-show="$store.sidebar.isOpen"><label class="text-sm text-gray-400">Main Menu</label></li>--}}
{{--                    <li>--}}
{{--                        <a href="#" class="fi-sidebar-nav-item flex items-center gap-x-3 text-sm" :class="!$store.sidebar.isOpen ?? 'justify-center'">--}}
{{--                            <x-heroicon-o-home class="w-6 h-6"/>--}}
{{--                            <span class="fi-sidebar-nav-item-label"  x-show="$store.sidebar.isOpen">Dashboard</span>--}}
{{--                        </a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
