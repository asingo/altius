...
@section('content')
    <div class="max-w-screen-2xl mx-auto pt-24 px-6 2xl:px-0 mt-6">
        <x-breadcrumb parent="Home" subparent="Health Screening" subparentlink="/health-screening" child="{{$title}}"/>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mt-10">
            ...
            <div class="md:col-span-2">
                ...
                <h2 class="font-heading text-2xl mt-8">Description</h2>
                <div class="mt-4 post-content">
                    {!! tiptap_converter()->asHTML($data->description) !!}
                </div>
                <div>
                    <x-button.link href="#" class="w-full text-center mt-4">Claim This Package</x-button.link>
                </div>
            </div>
        </div>
        <div class="bg-[#EAF1FB] my-24 py-2 text-lg rounded-xl flex justify-center items-center">
            <span class="me-3">Share to</span>
    ...
    <div class="pb-12 pt-6">
        <div class="max-w-screen-2xl mx-auto px-6 2xl:px-0">
            <h3 class="text-3xl font-heading font-medium">Related Health Screening</h3>
