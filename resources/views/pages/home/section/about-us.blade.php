<div class="max-w-screen-2xl mx-auto py-24 pb-12 px-6 2xl:px-0">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
            <img src="{{ \Awcodes\Curator\Models\Media::find(get_image_id($page->content['about']['image']))?->url }}" alt="icon" class="w-full">
        </div>
        <div>
            <x-typography.subheading location="section">{{$page->content['about']['title']}}</x-typography.subheading>
            <x-typography.heading>{{$page->content['about']['heading']}}</x-typography.heading>
