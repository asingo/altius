...
class CoeResource extends Resource
{
    use Translatable;
    ...
    protected static ?string $navigationLabel = 'Center of Excellence';
    ...
    {
        return [
            'index' => Pages\ListCoes::route('/'),
            'create' => Pages\CreateCoe::route('/create'),
            'edit' => Pages\EditCoe::route('/{record}/edit'),
        ];
    }
}
